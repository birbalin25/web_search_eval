...
| `web_search_agent.py` | Notebook: **LangChain `create_agent`** (LangGraph agent) using a Foundation Model via the Unity AI Gateway, with `system.ai.web_search` as a tool; traces log to the shared experiment |
